...
In this project, we aim to apply [combinatorial approaches](https://github.com/ERATOMMSD/scenario_sampler_code) to search efficiently through configurations that are affected by pair-wise (or k-wise) changes. This extends prior work by Arcaini and Yamada, members of the MMSD-ERATO research center in Japan.
